...
# Example query and gallery features (replace with your actual features)
probFea = np.random.rand(10, 512)  # Query features (10 samples, 512 dimensions)
galFea = np.random.rand(100, 512)  # Gallery features (100 samples, 512 dimensions)
...
# Display the refined distance matrix
print("Final distance matrix shape:", final_dist.shape)
